            ...
            public void onResponse(@NonNull Call<ValueAdd> call, @NonNull Response<ValueAdd> response) {
                if (response.body() != null) {
                    ...
                    if (success == 1) {
                        ...
                        if (data.equals("like")) {
                            lblLikeUnlike.setTextColor(getResources().getColor(R.color.colorPrimary));
                            tanda = "1";
                            imglikeunlike.setColorFilter(getResources().getColor(R.color.colorPrimary));
                        }
                    }
                }
            }
                ...
                if (response.body() != null) {
                    ...
                    if (success == 1) {
                        ...
                        if (like.equals("1")) {
                            ...
                            lk -= 1;
                            lblLikeBerita.setText(String.valueOf(lk));
                            lblLikeUnlike.setTextColor(getResources().getColor(R.color.colorDefault));
                            tanda = "0";
                            imglikeunlike.setColorFilter(getResources().getColor(R.color.colorDefault));
                            llsuka.setEnabled(true);
                        }
//                        Intent intent = new Intent("refresh");
